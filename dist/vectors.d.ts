...
declare abstract class BasicObject<Geometry extends THREE.BufferGeometry> implements RendererObject<THREE.ColorRepresentation> {
...
export type ArrowColor = THREE.ColorRepresentation | {
	from: THREE.ColorRepresentation;
	to: THREE.ColorRepresentation;
};
declare class Arrow implements RendererObject<ArrowColor> {
	/**
...
declare class Circle extends BasicObject<THREE.CircleGeometry> {
...
declare class Cone extends BasicObject<THREE.ConeGeometry> {
...
declare class Cuboid extends BasicObject<THREE.BoxGeometry> {
...
declare class Cylinder extends BasicObject<THREE.CylinderGeometry> {
	constructor(ctx: Ctx, radiusTop: number, radiusBottom: number, height: number);
	/**
...
export type GraphColor = THREE.ColorRepresentation | ((x: number, y: number) => THREE.ColorRepresentation);
declare class Graph implements RendererObject<GraphColor> {
	/**
	...
	constructor(ctx: Ctx, func: (x: number) => number, range?: [
		number,
		number
	]);
	pos(position: Vec3): this;
...
export type LineStripColor = THREE.ColorRepresentation | {
	from: THREE.ColorRepresentation;
	to: THREE.ColorRepresentation;
} | THREE.ColorRepresentation[];
declare class LineStrip implements RendererObject<LineStripColor> {
	/**
...
export type PointsColor = THREE.ColorRepresentation | THREE.ColorRepresentation[];
declare class Points$1 implements RendererObject<PointsColor> {
	/**
...
declare class Sphere$1 extends BasicObject<THREE.SphereGeometry> {
	constructor(ctx: Ctx, radius: number);
	/**
...
declare class Torus extends BasicObject<THREE.TorusGeometry> {
...
declare class Text$1 extends BasicObject<THREE.ShapeGeometry> {
...
export declare class Ctx {
	 ...
	 */
	line: (start: Vec3, end: Vec3) => LineStrip;
	/**
	 ...
	 */
	lineStrip: (points: Vec3[]) => LineStrip;
	/**
	 ...
	 */
	arrow: (start: Vec3, end: Vec3, headLength?: number) => Arrow;
	/**
	 ...
	 * @returns The created {@link Arrow} instance.
	 */
	vector: (vec: Vec3, headLength?: number) => Arrow;
	/**
	 ...
	 */
	cuboid: (width: number, height: number, depth: number) => Cuboid;
	/**
	 ...
	 */
	cylinder: (radiusTop: number, radiusBottom: number, height: number) => Cylinder;
	/**
	 ...
	 */
	plane: (width: number, height: number) => Plane$1;
	/**
	 ...
	 * @returns
	 */
	torus: (radius: number, tubeRadius: number) => Torus;
	/**
	 ...
	 */
	cone: (radius: number, height: number) => Cone;
	/**
	 ...
	 */
	graph: (func: (x: number) => number, range?: [
		number,
		number
	]) => Graph;
	/**
	 ...
	 */
	graph3d: (func: (x: number, z: number) => number, size?: Vec2) => Graph3d;
	/**
	 ...
	 */
	heightField: (size: Vec2, segments: Vec2, heights: Float64Array | number[]) => HeightField;
	/**
 ...
 */
export declare const noise: (pos: number | Vec2 | Vec3, seed?: string) => number;
/**
 ...
 */
export declare const fbm: (pos: number | Vec2 | Vec3, config?: {
	seed?: string;
	octaves?: number;
	lacunarity?: number;
	gain?: number;
